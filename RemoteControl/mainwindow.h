...
private slots:
    ...
    // Slider değer değişimi slotları (sadece UI güncelleme)
    void on_scrollP_valueChanged(int value);
    void on_scrollD_valueChanged(int value);
    void on_scrollC_valueChanged(int value);
    void on_scrollV_valueChanged(int value);
    void on_scrollAC_valueChanged(int value);

    // Slider bırakma slotları (değer gönderme)
    void on_scrollP_sliderReleased();
    void on_scrollD_sliderReleased();
    void on_scrollC_sliderReleased();
    void on_scrollV_sliderReleased();
    void on_scrollAC_sliderReleased();
